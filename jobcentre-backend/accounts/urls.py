...
from .views import AccountDeleteView, MeView, PasswordResetConfirmView, PasswordResetRequestView, ProfileView, RegisterView, TalentDirectoryView, TalentProfileView
