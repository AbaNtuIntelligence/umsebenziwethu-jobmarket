...
from .views import AccountDeleteView, EmployerLogoDeleteView, LoginView, LogoutView, MeView, PasswordResetConfirmView, PasswordResetRequestView, PhoneOTPSendView, PhoneOTPVerifyView, ProfileView, RefreshTokenView, RegisterView, TalentDirectoryView, TalentProfileView
